...
import { normalizeClassName, inheritProps } from '../utils';
...
export { providerI18nContentOptions } from './provider';
          ...
          _props => {
            ...
            return (
              <Dropdown
                ...
                class={normalizeClassName('fat-i18n-content__dropdown', finalOptions.position, finalOptions.badgeClass)}
                style={finalOptions.badgeStyle}
                v-slots={{
