...
// TODO: 优化类型
export interface TreeEvents<K, D extends TreeData> {
  onNodeClick?: (d: D, node: TreeNode<K, D>, component: any) => void;
  onNodeContextmenu?: (event: any, d: D, node: TreeNode<K, D>, component: any) => void;
  onCheckChange?: (d: D, checked: boolean, childChecked: boolean) => void;
  onCheck?: (d: D, checkState: any) => void;
...
/** Tree Component */
export interface TreeProps<K, D extends TreeData> extends TreeEvents<K, D> {
  // /** TreeStore */
  // store: TreeStore<K, D>;
   ...
   */
  renderContent?: (h: any, context: { node: TreeNode<K, D>; data: D; store: TreeStore<K, D> }) => any;
...
export interface TreeMethods<K, D extends TreeData> {
  /**
...
export const Tree: <K = string | number, D extends TreeData = TreeData>(props: TreeProps<K, D>) => any;
